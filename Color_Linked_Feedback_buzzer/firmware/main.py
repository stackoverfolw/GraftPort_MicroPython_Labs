...
def button_handler(pin: Pin) -> None:
    ...
    """
    global sensor_task, tcs_sensor, buzzer, touch
...
BUzzer = Buzzer(pin=board.get_dio_pins(1)[0])
...
# ------------------- 创建任务 -------------------
sensor_task_obj = SensorRGBSoundTask(touch_key=touch, rgb_sensor=tcs_sensor, buzzer=BUzzer, enable_debug=True)
